            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="gestionODA.html">Gestión ODA</a>
                        <a class="collapse-item" href="clientes.html">Clientes</a>
                        <a class="collapse-item" href="vehiculos.html">Vehículos</a>
                    </div>
                </div>
            </li>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="producto_data" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>Nombre</th>
                                            <th></th>
